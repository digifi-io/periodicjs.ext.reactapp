...
var jwt_token = {
  TOKEN_NAME: _settings.AppConfigSettings.name + '_jwt_token',
  TOKEN_DATA: _settings.AppConfigSettings.name + '_jwt_token_data',
  PROFILE_JSON: _settings.AppConfigSettings.name + '_jwt_profile'
};
var cache = {
  CONFIGURATION_CACHE: _settings.AppConfigSettings.name + '_configuration'
};
...
exports.default = {
  ...
  pages: pages,
  tabBarExtensions: tabBarExtensions,
  fetchData: fetchData,
  user: user,
  clientCacheData: clientCacheData,
  dynamic: dynamic,
  output: output,
  jwt_token: jwt_token,
  cache: cache,
