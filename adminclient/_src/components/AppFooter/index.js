  ...
  (0, _createClass3.default)(AppFooter, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        _reBulma.Nav,
        { style: (0, _assign2.default)({}, _styles2.default.fixedBottom, _styles2.default.footerContainer, this.props.settings.ui.footer.navStyle), className: 'animated fadeInUp Header-Speed reactapp__app_footer' },
