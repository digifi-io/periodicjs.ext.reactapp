...
class AppFooter extends Component {
  ...
  render() {
    return (
      <Nav style={Object.assign({}, styles.fixedBottom, styles.footerContainer, this.props.settings.ui.footer.navStyle)} className={'animated fadeInUp Header-Speed reactapp__app_footer'}>
